            ...
            <main className="flex-grow">
                ...
                <section className="bg-brand-orange py-16 text-white overflow-hidden text-center relative">
                    <div className="container max-w-4xl mx-auto px-4 relative z-10">
                        ...
                        <a
                            href="/custom-cake"
                            className="inline-block bg-white text-brand-orange hover:bg-brand-brown hover:text-white transition-colors duration-300 font-bold px-10 py-5 rounded-full text-lg shadow-xl"
                        >
