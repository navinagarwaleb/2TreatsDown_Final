...
export default function AboutUs() {
    return (
        <main className="min-h-screen bg-brand-light pb-24 animate-in fade-in duration-500">
            {/* Header Section (Matching Reviews Page) */}
            <section className="bg-brand-main py-20 border-b border-brand-pink relative overflow-hidden">
                <div className="container mx-auto px-4 max-w-4xl text-center relative z-10">
                    ...
                    <p className="text-lg md:text-xl text-brand-dark/80 max-w-2xl mx-auto leading-relaxed">
                        Discover the story behind 2 Treats Down, our values, and our passion for crafting healthy, natural treats for your best friend.
                    </p>
                </div>
                {/* Decorative Elements */}
            ...
            <div className="container mx-auto px-4 max-w-5xl py-20 md:py-28">
                <div className="space-y-24">
                    ...
                    >
                        <h2 className="text-3xl font-heading font-bold text-brand-orange text-center md:text-left">How It All Started</h2>
                    ...
                    >
                        <div className="relative aspect-[4/3] rounded-3xl overflow-hidden shadow-lg border-4 border-brand-pink/50">
                            <Image src="/images/about/1.jpeg" fill alt="From one birthday to a bigger dream" className="object-cover" />
                        </div>
                    ...
                    >
                        ...
                        <div className="order-1 md:order-2 relative aspect-[4/3] rounded-3xl overflow-hidden shadow-lg border-4 border-brand-pink/50">
                            <Image src="/images/about/2.jpeg" fill alt="Trial, Error and Honest Feedback" className="object-cover" />
                        </div>
                    </motion.section>
                    ...
                    >
                        <div className="relative aspect-[4/3] rounded-3xl overflow-hidden shadow-lg border-4 border-brand-pink/50">
                            <Image src="/images/about/3.jpeg" fill alt="What Makes Us Different" className="object-cover" />
                        </div>
                        <div className="space-y-4">
                    ...
                    >
                        ...
                        <div className="order-1 md:order-2 relative aspect-[4/3] rounded-3xl overflow-hidden shadow-lg border-4 border-brand-pink/50">
                            <Image src="/images/about/4.jpeg" fill alt="Community love" className="object-cover" />
                        </div>
                    </motion.section>
                    ...
                    >
                        <div className="relative aspect-[4/3] rounded-3xl overflow-hidden shadow-lg border-4 border-brand-pink/50">
                            <Image src="/images/about/5.png" fill alt="Meet the faces" className="object-cover object-top" />
                        </div>
                        <div className="space-y-4">
                    ...
                    <motion.section
                        ...
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true }}
                        className="pt-12 border-t border-brand-pink grid grid-cols-1 md:grid-cols-2 gap-12 items-center"
                    >
                        <div className="order-2 md:order-1 space-y-4">
                            <h2 className="text-3xl font-heading font-bold text-brand-orange">A Milestone I’ll Never Forget</h2>
                            <div className="text-brand-dark/80 space-y-4 leading-relaxed text-lg">
                                ...
                                <div className="pt-6 flex justify-center">
                                    <p className="font-heading text-xl font-bold bg-brand-pink/60 inline-block px-6 py-3 rounded-full text-brand-brown text-center">
                                        This is me.<br />
                        ...
                        <div className="order-1 md:order-2 relative aspect-[4/3] rounded-3xl overflow-hidden shadow-lg border-4 border-brand-pink/50">
                            <Image src="/images/about/6.jpeg" fill alt="Ottawa Community Votes Platinum Award" className="object-cover" />
                        </div>
                    </motion.section>
                </div>
            </div>
